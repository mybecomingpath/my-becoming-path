...
<h2 className="mt-5 max-w-4xl font-serif text-3xl leading-[1.08] text-[#F4F1EA] md:text-4xl">
  I help outliers clear the aftermath of life disruption & build an unshakable foundation for their next evolution.
</h2>

<p className="mt-5 max-w-3xl text-[1.15rem] leading-[1.55] text-[#F2F4F1] font-normal">
  Grounded support for navigating major life disruption, identity shifts, personal growth, and new beginnings through coaching, connection, and community.
</p>
